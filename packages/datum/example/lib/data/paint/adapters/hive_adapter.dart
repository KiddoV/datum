...
class PaintStrokeHiveAdapter extends LocalAdapter<PaintStroke> {
  /// The name of the Hive box where entities of type `PaintStroke` will be stored.
  final String entityBoxName = 'paint_strokes';
  ...
  @override
  Future<void> create(PaintStroke entity) {
  ...
  @override
  Future<Map<String, PaintStroke>> readByIds(List<String> ids,
      {required String userId}) async {
    final results = <String, PaintStroke>{};
    for (final id in ids) {
  ...
  @override
  Future<void> update(PaintStroke entity) {
    return entityBox.put(entity.id, entity.toDatumMap(target: MapTarget.local));
  }

  @override
  Future<PaintStroke> patch(
      {required String id,
  ...
  Future<void> addPendingOperation(
      String userId, DatumSyncOperation<PaintStroke> operation) async {
  ...
  @override
  Future<List<DatumSyncOperation<PaintStroke>>> getPendingOperations(
      String userId) async {
    final opsList = pendingOpsBox.get(userId);
  ...
  @override
  Future<DatumSyncResult<PaintStroke>?> getLastSyncResult(String userId) async {
  ...
  @override
  Future<PaginatedResult<PaintStroke>> readAllPaginated(PaginationConfig config,
      {String? userId}) {
  ...
  @override
  Future<List<PaintStroke>> query(DatumQuery query, {String? userId}) {
