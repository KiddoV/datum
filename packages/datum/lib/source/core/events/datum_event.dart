...
@immutable
abstract class DatumSyncEvent<T extends DatumEntityInterface> {
...
class DatumSyncStartedEvent<T extends DatumEntityInterface> extends DatumSyncEvent<T> {
...
class DatumSyncProgressEvent<T extends DatumEntityInterface> extends DatumSyncEvent<T> {
...
class DatumSyncCompletedEvent<T extends DatumEntityInterface> extends DatumSyncEvent<T> {
...
class DatumSyncErrorEvent<T extends DatumEntityInterface> extends DatumSyncEvent<T> {
