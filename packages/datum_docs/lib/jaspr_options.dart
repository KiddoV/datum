...
import 'package:jaspr_content/components/_internal/code_block_copy_button.dart'
    as prefix8;
import 'package:jaspr_content/components/_internal/tab_bar.dart' as prefix9;
...
JasprOptions get defaultJasprOptions => JasprOptions(
  clients: {
    ...
    prefix9.TabBar: ClientTarget<prefix9.TabBar>(
      'jaspr_content:components/_internal/tab_bar',
      params: _prefix9TabBar,
    ),

    prefix10.ZoomableImage: ClientTarget<prefix10.ZoomableImage>(
      'jaspr_content:components/_internal/zoomable_image',
      params: _prefix10ZoomableImage,
    ),
  ...
  styles: () => [
    ...
    ...prefix7.Tip.styles,
    ...prefix9.TabBar.styles,
    ...prefix10.ZoomableImage.styles,
...
Map<String, dynamic> _prefix9TabBar(prefix9.TabBar c) => {
  'initialValue': c.initialValue,
  'items': c.items,
};
Map<String, dynamic> _prefix10ZoomableImage(prefix10.ZoomableImage c) => {
  'src': c.src,
  'alt': c.alt,
  'caption': c.caption,
};
