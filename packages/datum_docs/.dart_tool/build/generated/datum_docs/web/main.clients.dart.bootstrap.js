...
let modulePaths = {
 "dart_sdk": "packages/jaspr_web_compilers/src/dev_compiler/dart_sdk",
 ...
 "packages/jaspr/browser": "packages/jaspr/browser.ddc",
 "packages/jaspr/src/browser/utils": "packages/jaspr/src/browser/utils.ddc",
 "packages/jaspr_content/components/_internal/code_block_copy_button": "packages/jaspr_content/components/_internal/code_block_copy_button.ddc",
 "packages/jaspr_content/components/_internal/code_block_copy_button.client": "packages/jaspr_content/components/_internal/code_block_copy_button.client.ddc",
 "packages/jaspr_content/components/_internal/icon": "packages/jaspr_content/components/_internal/icon.ddc",
 "packages/jaspr_content/components/_internal/zoomable_image": "packages/jaspr_content/components/_internal/zoomable_image.ddc",
 "packages/jaspr_content/components/_internal/zoomable_image.client": "packages/jaspr_content/components/_internal/zoomable_image.client.ddc",
 "packages/jaspr_content/components/github_button": "packages/jaspr_content/components/github_button.ddc",
 "packages/jaspr_content/components/github_button.client": "packages/jaspr_content/components/github_button.client.ddc",
 "packages/jaspr_content/components/sidebar_toggle_button": "packages/jaspr_content/components/sidebar_toggle_button.ddc",
 "packages/jaspr_content/components/sidebar_toggle_button.client": "packages/jaspr_content/components/sidebar_toggle_button.client.ddc",
 "packages/jaspr_content/components/theme_toggle": "packages/jaspr_content/components/theme_toggle.ddc",
 "packages/jaspr_content/components/theme_toggle.client": "packages/jaspr_content/components/theme_toggle.client.ddc",
 "packages/jaspr_content/src/content": "packages/jaspr_content/src/content.ddc",
 "packages/jaspr_content/src/theme/_base": "packages/jaspr_content/src/theme/_base.ddc",
 "packages/jaspr_content/theme": "packages/jaspr_content/theme.ddc",
 ...
 "web/main.clients": "main.clients.ddc",
 "web/main.clients.bootstrap": "main.clients.bootstrap.ddc"
};
if(!window.$dartLoader) {
   window.$dartLoader = {
     appDigests: _currentDirectory + 'main.clients.digests',
...
define("main.clients.dart.bootstrap", ["web/main.clients.bootstrap", "dart_sdk"], function(app, dart_sdk) {
  ...
  (app.web__main$46clients$46bootstrap || app.main$46clients$46bootstrap).main();
  var bootstrap = {
      hot$onChildUpdate: function(childName, child) {
        ...
        if (childName === "main.clients.bootstrap.dart") {
          // Clear static caches.
  ...
  dart_sdk.dart.trackLibraries("main.clients.dart.bootstrap", {
    "main.clients.dart.bootstrap": bootstrap
  }, '');
  return {
    bootstrap: bootstrap
  };
